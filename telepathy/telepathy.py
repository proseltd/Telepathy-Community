...
def cli(target, comprehensive, media, forwards, user, location, alt, json, export, replies):
    ...
    for t in target:
        ...
        async def main():
            ...
            if not await client.is_user_authorized():
                ...
                if basic == True:
                    print(
                        Fore.GREEN + " [!] " + Style.RESET_ALL + "Performing basic scan"
                    )
                ...
                if basic is True or comp_check is True:
                    ...
                    if chat_type != "Channel":
                        ...
                        pass
                    print(Fore.GREEN + "  ┬  Chat details" + Style.RESET_ALL)
                    ...
                    print(Fore.GREEN + "  ├  URL: " + Style.RESET_ALL + str(group_url))
                    print(
                        Fore.GREEN
                        + "  ├  Chat type: "
                        + Style.RESET_ALL
                    ...
                    print(
                        Fore.GREEN + "  ├  Chat id: " + Style.RESET_ALL + str(entity.id)
                    )
                    print(
                        Fore.GREEN
                        + "  ├  Access hash: "
                    ...
                    if forwards_check is True and comp_check is False:
                        ...
                        if comp_check is True:
                                ...
                                async for message in client.iter_messages(
                                    ...
                                    if message is not None:
                                        try:
                                            ...
                                            if message.replies and reply_analysis and chat_type == "Channel" :
                            ...
                            print(Fore.GREEN + "  ┬  Chat statistics" + Style.RESET_ALL)
                            print(
                                Fore.GREEN
                ...
                if location_check == True:
                    ...
                    print(Fore.GREEN + " [+] Users located" + Style.RESET_ALL)
                    print(
                        Fore.GREEN
                        + "  ├  Users within 500m:  "
                        + Style.RESET_ALL
